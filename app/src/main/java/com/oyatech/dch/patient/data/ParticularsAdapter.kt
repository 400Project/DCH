...
class ParticularsAdapter(private var particularList: List<Particulars>):
   ...
   /*     val binding = PatientPaticularsCardBinding.inflate(LayoutInflater.from(parent.context),pa)
        return ParticularsViewHolder(binding.root)*/
val particularsLayout = LayoutInflater.from(parent.context)
    .inflate(R.layout.patient_particulars_card,parent,false)
